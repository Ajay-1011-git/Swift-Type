...
import { signIn } from "@/backend/services/firebase";
function Login() {
  ...
  return <div className="flex-1 flex items-center justify-center px-6 py-12">
    ...
    /* Form */
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {error && <div className="px-5 py-4 bg-[#ca4754]/10 border border-[#ca4754]/20 rounded-xl text-[#ca4754] text-sm animate-fade-in">
              {error}
            </div>}
    ...
    required
    className="w-full px-5 py-4 text-base bg-[#2c2e31] text-[#d1d0c5] rounded-xl border border-[#363739] focus:border-[#e2b714] outline-none transition-all duration-200 placeholder:text-[#454647]"
  ...
  >
        ...
        <p className="text-center text-base text-[#646669] mt-8">
          ...
          <Link to="/signup" className="text-[#e2b714] font-semibold hover:underline transition-all">
            Sign up
          </Link>
        </p>
      </div>
