...
export default function Leaderboard() {
  ...
  // Placeholder data — in production this would come from Firestore
  ...
  return (
    <div className="flex-1 w-full max-w-6xl mx-auto px-6 py-8 font-sans-swift animate-fade-in-up">
      {/* Header */}
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-all duration-200 ${
              selectedMode === mode
                ...
                : 'bg-[#2c2e31] text-[#646669] hover:text-[#d1d0c5]'
            }`}
          >
            {mode}
          </button>
          ...
          <table className="w-full">
            ...
            <tbody>
              {entries.map((entry, index) => (
                <tr
                  key={entry.rank}
                  className={`hover:bg-[#323437] transition-colors duration-150 ${
                    index !== entries.length - 1
                      ? 'border-b border-[#646669] border-opacity-10'
                      : ''
                  }`}
                >
