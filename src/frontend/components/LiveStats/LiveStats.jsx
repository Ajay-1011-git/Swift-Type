...
function LiveStats() {
  ...
  return <div className="w-full max-w-4xl mx-auto px-4 mb-4 animate-fade-in-up">
    ...
    /* Accuracy */
        ...
        <div className="flex items-center gap-2">
          ...
          <span
    className={`font-bold text-lg ${accuracy >= 95 ? "text-[#d1d0c5]" : accuracy >= 85 ? "text-[#e2b714]" : "text-[#ca4754]"}`}
  >
            {accuracy.toFixed(1)}%
          </span>
        </div>
    ...
    /* Best WPM */
        ...
        {bestWpm > 0 && <div className="flex items-center gap-2">
